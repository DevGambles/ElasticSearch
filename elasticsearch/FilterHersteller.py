...
limit_count = None
new_index = "primary_hersteller"
old_index = "secondary_hersteller"
...
def query():
    ...
    try:
        ...
        sql_query = """
            SELECT
                id, HERSTELLERNAME, URLSTRUKTUR, anzahl
            FROM
                hersteller
            ORDER BY
            anzahl DESC
...
def main():
    ...
    print("Imported Records:", len(hersteller))

    add_alias(option='hersteller', add_index=ind_name)
